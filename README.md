...
**Excel Data Analysis Project by Ayodele Mary**
...
This project showcases how data-driven insights can guide better business decisions through:
...
- **Peak sales** occur between February and April; the decline afterward suggests seasonal dependency  
- **Female customers** dominate sales (64%), making them a major growth driver  
- **Adult and senior women** contribute over **50%** of total orders  
- **Top states**: Maharashtra, Karnataka, Uttar Pradesh  
- **93% of orders** are delivered successfully, indicating efficient logistics  
- **Top retailers**: Amazon and Myntra  
- **7% returns/refunds** highlight potential improvements in product quality and sizing  
...
- Introduce **discount campaigns** in slower months (August–December)  
- Use **customer retention offers** before seasonal decline  

### Gender-Based Sales

- Expand the **women’s product line** (styles, accessories)  
- Launch male-oriented campaigns (for example, *“Men’s Fashion Fest”*)  
...
**Ayodele Mary**  
📍 Business Analyst \| Excel Enthusiast \| Storyteller with Data  
📧 [ayodelemaryann@gmail.com](mailto:ayodelemaryann@gmail.com)
